...
import (
	...
	"github.com/appuio/scheduler-canary-controller/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "c8138e14.appuio.io",
	...
	if err = (&controllers.SchedulerCanaryReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SchedulerCanary")
		os.Exit(1)
	}
